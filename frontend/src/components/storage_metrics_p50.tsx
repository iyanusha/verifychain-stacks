...
interface Storage_metricsP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP50({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP50Props) {
