...
interface Proof_viewerP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP11({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP11Props) {
