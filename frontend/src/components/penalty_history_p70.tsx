...
interface Penalty_historyP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP70({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP70Props) {
