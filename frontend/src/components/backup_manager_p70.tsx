...
interface Backup_managerP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP70({ title = 'Add backup management system', data, onAction }: Backup_managerP70Props) {
