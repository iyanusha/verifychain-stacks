...
interface Health_checkP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP50({ title = 'Add health check monitoring', data, onAction }: Health_checkP50Props) {
