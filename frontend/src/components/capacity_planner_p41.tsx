...
interface Capacity_plannerP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP41({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP41Props) {
