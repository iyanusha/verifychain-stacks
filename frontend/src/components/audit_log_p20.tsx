...
interface Audit_logP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP20({ title = 'Add audit log system', data, onAction }: Audit_logP20Props) {
