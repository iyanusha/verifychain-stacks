...
interface Storage_metricsP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP0({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP0Props) {
