...
interface Storage_metricsP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP61({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP61Props) {
