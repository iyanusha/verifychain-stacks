...
interface Chunk_browserP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP11({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP11Props) {
