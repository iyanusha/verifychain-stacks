...
interface Penalty_historyP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP51({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP51Props) {
