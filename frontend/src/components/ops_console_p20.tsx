...
interface Ops_consoleP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP20({ title = 'Add operations console', data, onAction }: Ops_consoleP20Props) {
