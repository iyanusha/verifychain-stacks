...
interface Uptime_trackerP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP71({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP71Props) {
