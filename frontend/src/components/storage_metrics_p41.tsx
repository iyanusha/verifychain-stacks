...
interface Storage_metricsP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP41({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP41Props) {
