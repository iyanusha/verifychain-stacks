...
interface Storage_metricsP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP40({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP40Props) {
