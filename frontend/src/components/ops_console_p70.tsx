...
interface Ops_consoleP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP70({ title = 'Add operations console', data, onAction }: Ops_consoleP70Props) {
