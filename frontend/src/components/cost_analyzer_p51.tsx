...
interface Cost_analyzerP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Cost_analyzerP51({ title = 'Add cost analysis tools', data, onAction }: Cost_analyzerP51Props) {
