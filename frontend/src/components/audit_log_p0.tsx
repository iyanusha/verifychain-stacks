...
interface Audit_logP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP0({ title = 'Add audit log system', data, onAction }: Audit_logP0Props) {
