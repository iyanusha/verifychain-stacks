...
interface Node_monitorP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP20({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP20Props) {
