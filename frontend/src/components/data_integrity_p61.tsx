...
interface Data_integrityP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_integrityP61({ title = 'Add data integrity checker', data, onAction }: Data_integrityP61Props) {
