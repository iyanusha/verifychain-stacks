...
interface Reward_distributionP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP10({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP10Props) {
