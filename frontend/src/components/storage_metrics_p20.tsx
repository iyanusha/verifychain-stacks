...
interface Storage_metricsP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP20({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP20Props) {
