...
interface Sla_monitorP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP70({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP70Props) {
