...
interface Chunk_browserP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP50({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP50Props) {
