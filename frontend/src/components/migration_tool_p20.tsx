...
interface Migration_toolP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP20({ title = 'Add data migration tools', data, onAction }: Migration_toolP20Props) {
