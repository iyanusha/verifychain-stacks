...
interface Capacity_plannerP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP51({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP51Props) {
