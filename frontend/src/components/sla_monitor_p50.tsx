...
interface Sla_monitorP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP50({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP50Props) {
