...
interface Chunk_browserP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP40({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP40Props) {
