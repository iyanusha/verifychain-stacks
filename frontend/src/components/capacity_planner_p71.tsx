...
interface Capacity_plannerP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP71({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP71Props) {
