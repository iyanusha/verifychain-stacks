...
interface Sla_monitorP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP71({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP71Props) {
