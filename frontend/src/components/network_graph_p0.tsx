...
interface Network_graphP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_graphP0({ title = 'Add network topology graph', data, onAction }: Network_graphP0Props) {
