...
interface Sla_monitorP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP11({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP11Props) {
