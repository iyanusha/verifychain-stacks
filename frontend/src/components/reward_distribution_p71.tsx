...
interface Reward_distributionP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP71({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP71Props) {
