...
interface Backup_managerP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP50({ title = 'Add backup management system', data, onAction }: Backup_managerP50Props) {
