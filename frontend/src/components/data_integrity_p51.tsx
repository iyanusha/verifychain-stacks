...
interface Data_integrityP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_integrityP51({ title = 'Add data integrity checker', data, onAction }: Data_integrityP51Props) {
