...
interface Proof_viewerP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP40({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP40Props) {
