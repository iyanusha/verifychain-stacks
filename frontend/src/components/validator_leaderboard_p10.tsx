...
interface Validator_leaderboardP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP10({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP10Props) {
