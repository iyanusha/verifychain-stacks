...
interface Ops_consoleP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP31({ title = 'Add operations console', data, onAction }: Ops_consoleP31Props) {
