...
interface Uptime_trackerP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP30({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP30Props) {
