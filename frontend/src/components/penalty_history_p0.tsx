...
interface Penalty_historyP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP0({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP0Props) {
