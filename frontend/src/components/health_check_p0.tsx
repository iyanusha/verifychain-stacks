...
interface Health_checkP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP0({ title = 'Add health check monitoring', data, onAction }: Health_checkP0Props) {
