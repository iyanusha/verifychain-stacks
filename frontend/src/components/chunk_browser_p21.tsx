...
interface Chunk_browserP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP21({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP21Props) {
