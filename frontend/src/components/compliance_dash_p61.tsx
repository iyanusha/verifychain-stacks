...
interface Compliance_dashP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP61({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP61Props) {
