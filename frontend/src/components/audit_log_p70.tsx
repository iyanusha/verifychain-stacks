...
interface Audit_logP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP70({ title = 'Add audit log system', data, onAction }: Audit_logP70Props) {
