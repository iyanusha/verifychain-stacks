...
interface Storage_metricsP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP60({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP60Props) {
