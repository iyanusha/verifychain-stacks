...
interface Uptime_trackerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP60({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP60Props) {
