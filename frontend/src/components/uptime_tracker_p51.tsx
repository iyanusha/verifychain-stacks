...
interface Uptime_trackerP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP51({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP51Props) {
