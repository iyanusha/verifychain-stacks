...
interface Proof_viewerP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP1({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP1Props) {
