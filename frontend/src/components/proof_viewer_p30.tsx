...
interface Proof_viewerP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP30({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP30Props) {
