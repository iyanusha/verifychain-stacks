...
interface Validator_leaderboardP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP51({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP51Props) {
