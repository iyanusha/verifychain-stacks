...
interface Compliance_dashP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP70({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP70Props) {
