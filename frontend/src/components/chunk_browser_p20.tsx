...
interface Chunk_browserP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP20({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP20Props) {
