...
interface Validator_leaderboardP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP20({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP20Props) {
