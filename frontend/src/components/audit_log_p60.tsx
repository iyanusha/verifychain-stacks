...
interface Audit_logP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP60({ title = 'Add audit log system', data, onAction }: Audit_logP60Props) {
