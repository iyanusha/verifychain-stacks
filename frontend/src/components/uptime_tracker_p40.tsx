...
interface Uptime_trackerP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP40({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP40Props) {
