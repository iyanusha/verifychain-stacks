...
interface Node_monitorP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP51({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP51Props) {
