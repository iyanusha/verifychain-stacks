...
interface Cost_analyzerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Cost_analyzerP60({ title = 'Add cost analysis tools', data, onAction }: Cost_analyzerP60Props) {
