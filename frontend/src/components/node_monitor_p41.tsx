...
interface Node_monitorP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP41({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP41Props) {
