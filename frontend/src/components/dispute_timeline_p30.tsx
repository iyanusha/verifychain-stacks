...
interface Dispute_timelineP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP30({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP30Props) {
