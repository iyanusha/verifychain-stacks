...
interface Network_graphP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_graphP51({ title = 'Add network topology graph', data, onAction }: Network_graphP51Props) {
