...
interface Node_monitorP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP40({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP40Props) {
