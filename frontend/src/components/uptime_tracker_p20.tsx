...
interface Uptime_trackerP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP20({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP20Props) {
