...
interface Backup_managerP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP11({ title = 'Add backup management system', data, onAction }: Backup_managerP11Props) {
