...
interface Ops_consoleP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP40({ title = 'Add operations console', data, onAction }: Ops_consoleP40Props) {
