...
interface Ops_consoleP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP10({ title = 'Add operations console', data, onAction }: Ops_consoleP10Props) {
