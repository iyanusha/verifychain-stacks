...
interface Capacity_plannerP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP31({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP31Props) {
