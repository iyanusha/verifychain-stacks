...
interface Penalty_historyP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP10({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP10Props) {
