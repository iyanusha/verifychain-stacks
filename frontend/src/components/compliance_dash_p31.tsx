...
interface Compliance_dashP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP31({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP31Props) {
