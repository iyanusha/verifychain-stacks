...
interface Reward_distributionP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP11({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP11Props) {
