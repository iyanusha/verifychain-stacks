...
interface Dispute_timelineP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP31({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP31Props) {
