...
interface Capacity_plannerP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP50({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP50Props) {
