...
interface Dispute_timelineP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP70({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP70Props) {
