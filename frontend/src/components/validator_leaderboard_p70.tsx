...
interface Validator_leaderboardP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP70({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP70Props) {
