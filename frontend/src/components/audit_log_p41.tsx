...
interface Audit_logP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP41({ title = 'Add audit log system', data, onAction }: Audit_logP41Props) {
