...
interface Backup_managerP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP21({ title = 'Add backup management system', data, onAction }: Backup_managerP21Props) {
