...
interface Reward_distributionP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP20({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP20Props) {
