...
interface Reward_distributionP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP60({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP60Props) {
