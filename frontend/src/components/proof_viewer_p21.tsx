...
interface Proof_viewerP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP21({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP21Props) {
