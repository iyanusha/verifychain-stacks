...
interface Data_integrityP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_integrityP1({ title = 'Add data integrity checker', data, onAction }: Data_integrityP1Props) {
