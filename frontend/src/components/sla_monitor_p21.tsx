...
interface Sla_monitorP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP21({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP21Props) {
