...
interface Penalty_historyP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP20({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP20Props) {
