...
interface Capacity_plannerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP60({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP60Props) {
