...
interface Validator_leaderboardP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP40({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP40Props) {
