...
interface Reward_distributionP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP0({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP0Props) {
