...
interface Migration_toolP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP0({ title = 'Add data migration tools', data, onAction }: Migration_toolP0Props) {
