...
interface Capacity_plannerP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP61({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP61Props) {
