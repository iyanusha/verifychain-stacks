...
interface Network_graphP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_graphP40({ title = 'Add network topology graph', data, onAction }: Network_graphP40Props) {
