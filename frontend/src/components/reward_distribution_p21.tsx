...
interface Reward_distributionP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP21({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP21Props) {
