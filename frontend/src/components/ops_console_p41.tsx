...
interface Ops_consoleP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP41({ title = 'Add operations console', data, onAction }: Ops_consoleP41Props) {
