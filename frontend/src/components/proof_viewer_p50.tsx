...
interface Proof_viewerP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP50({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP50Props) {
