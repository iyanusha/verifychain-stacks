...
interface Proof_viewerP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP31({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP31Props) {
