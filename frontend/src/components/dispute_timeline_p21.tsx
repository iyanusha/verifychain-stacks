...
interface Dispute_timelineP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP21({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP21Props) {
