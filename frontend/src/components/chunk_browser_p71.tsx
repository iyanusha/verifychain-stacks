...
interface Chunk_browserP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP71({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP71Props) {
