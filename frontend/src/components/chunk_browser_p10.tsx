...
interface Chunk_browserP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP10({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP10Props) {
