...
interface Data_integrityP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_integrityP60({ title = 'Add data integrity checker', data, onAction }: Data_integrityP60Props) {
