...
interface Health_checkP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP61({ title = 'Add health check monitoring', data, onAction }: Health_checkP61Props) {
