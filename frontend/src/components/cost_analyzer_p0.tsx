...
interface Cost_analyzerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Cost_analyzerP0({ title = 'Add cost analysis tools', data, onAction }: Cost_analyzerP0Props) {
