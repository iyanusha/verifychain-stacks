...
interface Compliance_dashP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP71({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP71Props) {
