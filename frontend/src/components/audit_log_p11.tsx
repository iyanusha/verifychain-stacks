...
interface Audit_logP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP11({ title = 'Add audit log system', data, onAction }: Audit_logP11Props) {
