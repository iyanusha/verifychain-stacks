...
interface Migration_toolP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP40({ title = 'Add data migration tools', data, onAction }: Migration_toolP40Props) {
