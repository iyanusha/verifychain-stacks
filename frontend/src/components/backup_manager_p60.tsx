...
interface Backup_managerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP60({ title = 'Add backup management system', data, onAction }: Backup_managerP60Props) {
