...
interface Migration_toolP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP30({ title = 'Add data migration tools', data, onAction }: Migration_toolP30Props) {
