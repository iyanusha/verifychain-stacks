...
interface Storage_metricsP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP21({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP21Props) {
