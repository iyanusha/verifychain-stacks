...
interface Sla_monitorP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP51({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP51Props) {
