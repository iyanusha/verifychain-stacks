...
interface Network_graphP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_graphP60({ title = 'Add network topology graph', data, onAction }: Network_graphP60Props) {
