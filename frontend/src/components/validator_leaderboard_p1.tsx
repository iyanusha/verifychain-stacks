...
interface Validator_leaderboardP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP1({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP1Props) {
