...
interface Compliance_dashP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP40({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP40Props) {
