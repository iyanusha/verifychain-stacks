...
interface Compliance_dashP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP30({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP30Props) {
