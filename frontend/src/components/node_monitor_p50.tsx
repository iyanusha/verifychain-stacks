...
interface Node_monitorP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP50({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP50Props) {
