...
interface Dispute_timelineP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP0({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP0Props) {
