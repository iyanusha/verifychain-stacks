...
interface Backup_managerP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP71({ title = 'Add backup management system', data, onAction }: Backup_managerP71Props) {
