...
interface Node_monitorP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP0({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP0Props) {
