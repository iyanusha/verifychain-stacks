...
interface Migration_toolP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP41({ title = 'Add data migration tools', data, onAction }: Migration_toolP41Props) {
