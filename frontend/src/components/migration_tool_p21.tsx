...
interface Migration_toolP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP21({ title = 'Add data migration tools', data, onAction }: Migration_toolP21Props) {
