...
interface Compliance_dashP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP10({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP10Props) {
