...
interface Audit_logP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP40({ title = 'Add audit log system', data, onAction }: Audit_logP40Props) {
