...
interface Penalty_historyP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP40({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP40Props) {
