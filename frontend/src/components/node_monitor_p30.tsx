...
interface Node_monitorP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP30({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP30Props) {
