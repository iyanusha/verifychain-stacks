...
interface Backup_managerP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP40({ title = 'Add backup management system', data, onAction }: Backup_managerP40Props) {
