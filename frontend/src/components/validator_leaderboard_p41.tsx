...
interface Validator_leaderboardP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP41({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP41Props) {
