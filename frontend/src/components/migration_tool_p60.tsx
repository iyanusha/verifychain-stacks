...
interface Migration_toolP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP60({ title = 'Add data migration tools', data, onAction }: Migration_toolP60Props) {
