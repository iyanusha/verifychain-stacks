...
interface Proof_viewerP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP41({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP41Props) {
