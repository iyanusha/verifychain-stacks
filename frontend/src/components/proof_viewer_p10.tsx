...
interface Proof_viewerP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP10({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP10Props) {
