...
interface Proof_viewerP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP20({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP20Props) {
