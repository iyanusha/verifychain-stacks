...
interface Uptime_trackerP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP50({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP50Props) {
