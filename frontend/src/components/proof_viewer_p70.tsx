...
interface Proof_viewerP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP70({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP70Props) {
