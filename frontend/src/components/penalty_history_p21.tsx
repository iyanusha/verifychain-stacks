...
interface Penalty_historyP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP21({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP21Props) {
