...
interface Sla_monitorP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP40({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP40Props) {
