...
interface Storage_metricsP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP10({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP10Props) {
