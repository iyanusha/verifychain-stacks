...
interface Node_monitorP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP21({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP21Props) {
