...
interface Migration_toolP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP50({ title = 'Add data migration tools', data, onAction }: Migration_toolP50Props) {
