...
interface Migration_toolP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP51({ title = 'Add data migration tools', data, onAction }: Migration_toolP51Props) {
