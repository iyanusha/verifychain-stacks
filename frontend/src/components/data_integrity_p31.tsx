...
interface Data_integrityP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_integrityP31({ title = 'Add data integrity checker', data, onAction }: Data_integrityP31Props) {
