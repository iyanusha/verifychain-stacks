...
interface Data_integrityP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_integrityP40({ title = 'Add data integrity checker', data, onAction }: Data_integrityP40Props) {
