...
interface Validator_leaderboardP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP31({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP31Props) {
