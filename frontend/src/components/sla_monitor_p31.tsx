...
interface Sla_monitorP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP31({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP31Props) {
