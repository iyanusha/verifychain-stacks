...
interface Backup_managerP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP31({ title = 'Add backup management system', data, onAction }: Backup_managerP31Props) {
