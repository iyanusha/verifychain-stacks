...
interface Capacity_plannerP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP21({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP21Props) {
