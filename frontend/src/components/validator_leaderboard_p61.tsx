...
interface Validator_leaderboardP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP61({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP61Props) {
