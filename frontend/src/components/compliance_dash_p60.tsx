...
interface Compliance_dashP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP60({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP60Props) {
