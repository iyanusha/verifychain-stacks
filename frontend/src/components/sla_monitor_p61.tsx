...
interface Sla_monitorP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP61({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP61Props) {
