...
interface Validator_leaderboardP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP71({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP71Props) {
