...
interface Chunk_browserP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP41({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP41Props) {
