...
interface Dispute_timelineP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP50({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP50Props) {
