...
interface Chunk_browserP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP1({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP1Props) {
