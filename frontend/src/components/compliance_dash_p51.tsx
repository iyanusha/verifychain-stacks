...
interface Compliance_dashP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP51({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP51Props) {
