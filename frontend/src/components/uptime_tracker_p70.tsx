...
interface Uptime_trackerP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP70({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP70Props) {
