...
interface Sla_monitorP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP30({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP30Props) {
