...
interface Capacity_plannerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP0({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP0Props) {
