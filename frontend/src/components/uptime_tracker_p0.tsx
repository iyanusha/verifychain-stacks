...
interface Uptime_trackerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP0({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP0Props) {
