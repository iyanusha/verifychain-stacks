...
interface Validator_leaderboardP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP21({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP21Props) {
