...
interface Health_checkP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP51({ title = 'Add health check monitoring', data, onAction }: Health_checkP51Props) {
