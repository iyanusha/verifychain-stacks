...
interface Chunk_browserP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP70({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP70Props) {
