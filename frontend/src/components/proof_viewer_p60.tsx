...
interface Proof_viewerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP60({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP60Props) {
