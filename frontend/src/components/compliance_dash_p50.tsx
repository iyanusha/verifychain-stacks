...
interface Compliance_dashP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP50({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP50Props) {
