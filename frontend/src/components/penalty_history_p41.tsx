...
interface Penalty_historyP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP41({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP41Props) {
