...
interface Penalty_historyP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP31({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP31Props) {
