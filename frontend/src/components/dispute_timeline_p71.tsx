...
interface Dispute_timelineP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP71({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP71Props) {
