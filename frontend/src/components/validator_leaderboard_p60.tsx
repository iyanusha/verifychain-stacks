...
interface Validator_leaderboardP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP60({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP60Props) {
