...
interface Node_monitorP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP10({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP10Props) {
