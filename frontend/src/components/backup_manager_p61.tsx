...
interface Backup_managerP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP61({ title = 'Add backup management system', data, onAction }: Backup_managerP61Props) {
