...
interface Health_checkP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP10({ title = 'Add health check monitoring', data, onAction }: Health_checkP10Props) {
