...
interface Audit_logP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP51({ title = 'Add audit log system', data, onAction }: Audit_logP51Props) {
