...
interface Compliance_dashP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP1({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP1Props) {
