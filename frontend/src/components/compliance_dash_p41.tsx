...
interface Compliance_dashP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP41({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP41Props) {
