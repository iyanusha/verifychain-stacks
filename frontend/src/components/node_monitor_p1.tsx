...
interface Node_monitorP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP1({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP1Props) {
