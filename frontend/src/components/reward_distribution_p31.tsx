...
interface Reward_distributionP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP31({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP31Props) {
