...
interface Dispute_timelineP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP1({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP1Props) {
