...
interface Audit_logP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP10({ title = 'Add audit log system', data, onAction }: Audit_logP10Props) {
