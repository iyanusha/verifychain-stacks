...
interface Ops_consoleP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP11({ title = 'Add operations console', data, onAction }: Ops_consoleP11Props) {
