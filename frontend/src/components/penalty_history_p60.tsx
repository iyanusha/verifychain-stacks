...
interface Penalty_historyP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP60({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP60Props) {
