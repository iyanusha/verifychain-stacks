...
interface Data_integrityP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_integrityP20({ title = 'Add data integrity checker', data, onAction }: Data_integrityP20Props) {
