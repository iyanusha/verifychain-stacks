...
interface Storage_metricsP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP11({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP11Props) {
