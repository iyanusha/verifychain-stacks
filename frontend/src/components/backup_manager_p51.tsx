...
interface Backup_managerP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP51({ title = 'Add backup management system', data, onAction }: Backup_managerP51Props) {
