...
interface Health_checkP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP60({ title = 'Add health check monitoring', data, onAction }: Health_checkP60Props) {
