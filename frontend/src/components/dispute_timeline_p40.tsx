...
interface Dispute_timelineP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP40({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP40Props) {
