...
interface Capacity_plannerP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP1({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP1Props) {
