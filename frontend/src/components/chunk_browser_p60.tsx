...
interface Chunk_browserP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP60({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP60Props) {
