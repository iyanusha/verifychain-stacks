...
interface Compliance_dashP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP21({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP21Props) {
