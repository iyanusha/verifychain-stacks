...
interface Capacity_plannerP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP40({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP40Props) {
