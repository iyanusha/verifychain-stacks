...
interface Dispute_timelineP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP61({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP61Props) {
