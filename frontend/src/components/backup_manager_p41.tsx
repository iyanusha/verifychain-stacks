...
interface Backup_managerP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP41({ title = 'Add backup management system', data, onAction }: Backup_managerP41Props) {
