...
interface Reward_distributionP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP51({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP51Props) {
