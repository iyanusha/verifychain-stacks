...
interface Health_checkP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP40({ title = 'Add health check monitoring', data, onAction }: Health_checkP40Props) {
