...
interface Capacity_plannerP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP20({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP20Props) {
