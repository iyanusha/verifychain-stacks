...
interface Backup_managerP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP10({ title = 'Add backup management system', data, onAction }: Backup_managerP10Props) {
