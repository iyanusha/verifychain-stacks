...
interface Audit_logP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP30({ title = 'Add audit log system', data, onAction }: Audit_logP30Props) {
