...
interface Chunk_browserP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP30({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP30Props) {
