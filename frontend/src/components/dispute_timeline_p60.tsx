...
interface Dispute_timelineP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP60({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP60Props) {
