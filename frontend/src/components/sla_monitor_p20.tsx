...
interface Sla_monitorP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP20({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP20Props) {
