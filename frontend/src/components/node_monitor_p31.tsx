...
interface Node_monitorP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP31({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP31Props) {
