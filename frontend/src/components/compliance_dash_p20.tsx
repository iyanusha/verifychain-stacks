...
interface Compliance_dashP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP20({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP20Props) {
