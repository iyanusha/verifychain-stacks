...
interface Ops_consoleP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP0({ title = 'Add operations console', data, onAction }: Ops_consoleP0Props) {
