...
interface Sla_monitorP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP60({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP60Props) {
