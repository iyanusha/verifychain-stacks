...
interface Validator_leaderboardP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP11({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP11Props) {
