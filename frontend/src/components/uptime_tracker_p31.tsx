...
interface Uptime_trackerP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP31({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP31Props) {
