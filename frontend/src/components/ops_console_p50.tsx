...
interface Ops_consoleP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP50({ title = 'Add operations console', data, onAction }: Ops_consoleP50Props) {
