...
interface Data_integrityP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_integrityP0({ title = 'Add data integrity checker', data, onAction }: Data_integrityP0Props) {
