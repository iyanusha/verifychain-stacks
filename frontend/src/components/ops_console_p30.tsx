...
interface Ops_consoleP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP30({ title = 'Add operations console', data, onAction }: Ops_consoleP30Props) {
