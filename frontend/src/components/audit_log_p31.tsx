...
interface Audit_logP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP31({ title = 'Add audit log system', data, onAction }: Audit_logP31Props) {
