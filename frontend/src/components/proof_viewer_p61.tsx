...
interface Proof_viewerP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP61({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP61Props) {
