...
interface Capacity_plannerP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP70({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP70Props) {
