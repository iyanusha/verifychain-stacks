...
interface Storage_metricsP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP1({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP1Props) {
