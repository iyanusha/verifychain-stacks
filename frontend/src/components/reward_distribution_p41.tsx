...
interface Reward_distributionP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP41({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP41Props) {
