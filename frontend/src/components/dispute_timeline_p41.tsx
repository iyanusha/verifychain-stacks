...
interface Dispute_timelineP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP41({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP41Props) {
