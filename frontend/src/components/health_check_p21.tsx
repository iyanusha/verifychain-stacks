...
interface Health_checkP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP21({ title = 'Add health check monitoring', data, onAction }: Health_checkP21Props) {
