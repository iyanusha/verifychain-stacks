...
interface Network_graphP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Network_graphP1({ title = 'Add network topology graph', data, onAction }: Network_graphP1Props) {
