...
interface Dispute_timelineP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP20({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP20Props) {
