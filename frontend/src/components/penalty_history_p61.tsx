...
interface Penalty_historyP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP61({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP61Props) {
