...
interface Penalty_historyP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP30({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP30Props) {
