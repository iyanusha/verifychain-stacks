...
interface Backup_managerP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP20({ title = 'Add backup management system', data, onAction }: Backup_managerP20Props) {
