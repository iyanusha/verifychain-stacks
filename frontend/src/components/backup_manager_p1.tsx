...
interface Backup_managerP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP1({ title = 'Add backup management system', data, onAction }: Backup_managerP1Props) {
