...
interface Migration_toolP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP1({ title = 'Add data migration tools', data, onAction }: Migration_toolP1Props) {
