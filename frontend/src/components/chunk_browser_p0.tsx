...
interface Chunk_browserP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Chunk_browserP0({ title = 'Add chunk data browser', data, onAction }: Chunk_browserP0Props) {
