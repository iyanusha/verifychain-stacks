...
interface Uptime_trackerP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP61({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP61Props) {
