...
interface Audit_logP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP21({ title = 'Add audit log system', data, onAction }: Audit_logP21Props) {
