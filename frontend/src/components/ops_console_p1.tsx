...
interface Ops_consoleP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP1({ title = 'Add operations console', data, onAction }: Ops_consoleP1Props) {
