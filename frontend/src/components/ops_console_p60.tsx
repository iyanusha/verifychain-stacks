...
interface Ops_consoleP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP60({ title = 'Add operations console', data, onAction }: Ops_consoleP60Props) {
