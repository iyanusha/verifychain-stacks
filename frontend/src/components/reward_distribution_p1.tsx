...
interface Reward_distributionP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP1({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP1Props) {
