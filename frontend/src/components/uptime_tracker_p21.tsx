...
interface Uptime_trackerP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP21({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP21Props) {
