...
interface Dispute_timelineP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP10({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP10Props) {
