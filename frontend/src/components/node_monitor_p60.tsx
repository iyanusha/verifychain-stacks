...
interface Node_monitorP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Node_monitorP60({ title = 'Add node monitoring dashboard', data, onAction }: Node_monitorP60Props) {
