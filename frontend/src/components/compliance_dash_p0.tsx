...
interface Compliance_dashP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Compliance_dashP0({ title = 'Add compliance dashboard', data, onAction }: Compliance_dashP0Props) {
