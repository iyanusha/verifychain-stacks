...
interface Uptime_trackerP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP11({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP11Props) {
