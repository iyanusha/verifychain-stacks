...
interface Sla_monitorP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP0({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP0Props) {
