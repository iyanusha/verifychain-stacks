...
interface Reward_distributionP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reward_distributionP70({ title = 'Add reward distribution panel', data, onAction }: Reward_distributionP70Props) {
