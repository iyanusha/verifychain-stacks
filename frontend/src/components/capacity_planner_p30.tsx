...
interface Capacity_plannerP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP30({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP30Props) {
