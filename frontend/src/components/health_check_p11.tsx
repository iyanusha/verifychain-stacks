...
interface Health_checkP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP11({ title = 'Add health check monitoring', data, onAction }: Health_checkP11Props) {
