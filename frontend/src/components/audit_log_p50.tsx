...
interface Audit_logP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Audit_logP50({ title = 'Add audit log system', data, onAction }: Audit_logP50Props) {
