...
interface Capacity_plannerP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP10({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP10Props) {
