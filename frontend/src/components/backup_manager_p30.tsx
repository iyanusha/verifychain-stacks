...
interface Backup_managerP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP30({ title = 'Add backup management system', data, onAction }: Backup_managerP30Props) {
