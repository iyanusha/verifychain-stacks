...
interface Storage_metricsP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP30({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP30Props) {
