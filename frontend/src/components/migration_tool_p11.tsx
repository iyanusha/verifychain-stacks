...
interface Migration_toolP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Migration_toolP11({ title = 'Add data migration tools', data, onAction }: Migration_toolP11Props) {
