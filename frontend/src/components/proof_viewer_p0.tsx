...
interface Proof_viewerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Proof_viewerP0({ title = 'Add proof verification viewer', data, onAction }: Proof_viewerP0Props) {
