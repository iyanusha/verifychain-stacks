...
interface Validator_leaderboardP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP0({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP0Props) {
