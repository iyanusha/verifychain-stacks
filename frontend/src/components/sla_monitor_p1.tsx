...
interface Sla_monitorP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP1({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP1Props) {
