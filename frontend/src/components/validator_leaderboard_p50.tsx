...
interface Validator_leaderboardP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Validator_leaderboardP50({ title = 'Add validator leaderboard', data, onAction }: Validator_leaderboardP50Props) {
