...
interface Health_checkP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Health_checkP1({ title = 'Add health check monitoring', data, onAction }: Health_checkP1Props) {
