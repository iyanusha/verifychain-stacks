...
interface Backup_managerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Backup_managerP0({ title = 'Add backup management system', data, onAction }: Backup_managerP0Props) {
