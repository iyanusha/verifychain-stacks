...
interface Dispute_timelineP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dispute_timelineP11({ title = 'Add dispute timeline component', data, onAction }: Dispute_timelineP11Props) {
