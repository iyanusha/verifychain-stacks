...
interface Storage_metricsP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Storage_metricsP51({ title = 'Add storage metrics visualization', data, onAction }: Storage_metricsP51Props) {
