...
interface Ops_consoleP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ops_consoleP71({ title = 'Add operations console', data, onAction }: Ops_consoleP71Props) {
