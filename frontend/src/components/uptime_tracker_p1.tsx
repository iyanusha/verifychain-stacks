...
interface Uptime_trackerP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP1({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP1Props) {
