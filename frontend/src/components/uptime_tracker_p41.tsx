...
interface Uptime_trackerP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Uptime_trackerP41({ title = 'Add uptime tracking system', data, onAction }: Uptime_trackerP41Props) {
