...
interface Sla_monitorP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Sla_monitorP10({ title = 'Add SLA monitoring dashboard', data, onAction }: Sla_monitorP10Props) {
