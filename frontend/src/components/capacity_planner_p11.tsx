...
interface Capacity_plannerP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Capacity_plannerP11({ title = 'Add capacity planning tools', data, onAction }: Capacity_plannerP11Props) {
