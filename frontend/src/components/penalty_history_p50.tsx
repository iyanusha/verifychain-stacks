...
interface Penalty_historyP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Penalty_historyP50({ title = 'Add penalty history viewer', data, onAction }: Penalty_historyP50Props) {
