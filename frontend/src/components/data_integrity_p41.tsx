...
interface Data_integrityP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_integrityP41({ title = 'Add data integrity checker', data, onAction }: Data_integrityP41Props) {
